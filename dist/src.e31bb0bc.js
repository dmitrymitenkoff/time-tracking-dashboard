...
var cards = document.querySelectorAll('.content');
...
function populateStats(period) {
  cards.forEach(function (card, index) {
    var currentHrs = card.querySelector('.stats__hrs--num');
    var previousHours = card.querySelector('.stats__prev__hrs');
...
},{"./data.json":"data.json"}],"index.js":[function(require,module,exports) {
"use strict";
